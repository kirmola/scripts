...
#     GOOGLE_URLS = [
#         f"https://www.google.com/complete/search?q={letter}&client=chrome&hl={hostlanguage}" for letter in ascii_lowercase]
...
#                 data.append(task)
#                 logging.info(
#                     f"Request No. {GOOGLE_URLS.index(eachURL)} completed.")
